<?php
/*
Plugin Name: LTKG for Yoast SEO
Description: توليد جملة واحدة طويلة الذيل وحفظها في Yoast SEO.
Version: 1.1
Author: Mona Jalal
*/
...
add_action('save_post', function($post_id) {
    ...
    $keywords = ltkg_extract_long_tail_phrases($text, 1);

    update_post_meta($post_id, '_yoast_wpseo_focuskw', $keywords[0]);
}, 20, 1);

function ltkg_extract_long_tail_phrases($text, $limit = 1) {
